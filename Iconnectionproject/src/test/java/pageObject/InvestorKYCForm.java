...
public class InvestorKYCForm extends BasePage {
	...
	@FindBy(xpath="//p[normalize-space()='Select investor type for form PF filing']") WebElement click_PF ;
	@FindBy(xpath="//li[normalize-space()='Individual that is not a United States person']") WebElement select_content;
	...
	@FindBy(xpath="//input[@id='input-18'][@class='v-field__input']") WebElement enter_email ;
